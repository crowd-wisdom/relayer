...
import { MAX_MESSAGES, MessageContractParamsDto, PublishMessagesDto } from "./dto/message.dto.js";
...
@Injectable()
export class MaciGuard implements CanActivate {
   ...
   */
    ...
    constructor(private readonly reflector: Reflector) {
      this.logger = new Logger(MaciGuard.name);
    }
