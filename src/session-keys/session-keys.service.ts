...
import { KernelEIP1193Provider } from "./provider/KernelEIP1193Provider.js";
import { IGenerateSessionKeyReturn } from "./types.js";
...
export class SessionKeysService {
  ...
  async getKernelClientSigner(kernelClient: KernelClientType): Promise<AASigner> {
    ...
    const aaSigner = signer as unknown as AASigner;
    aaSigner.isAA = true;
